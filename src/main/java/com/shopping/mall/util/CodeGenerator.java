...
public class CodeGenerator {
    ...
    private static final String dataUrl = "jdbc:mysql://localhost:3306/shooping_mall?serverTimezone=UTC&useUnicode=true&characterEncoding=utf8&characterSetResults=utf8";
    private static final String driverName = "com.mysql.cj.jdbc.Driver";
    private static final String parentPackage = "com.shopping.mall";
...
/*        // 自定义配置
        ...
        //默认生成全部
//        strategy.setExclude();
        strategy.setTablePrefix("shooping_mall_");
